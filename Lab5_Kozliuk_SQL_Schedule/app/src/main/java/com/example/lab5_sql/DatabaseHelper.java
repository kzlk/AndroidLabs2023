...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "Subjects_table";
    private static final String COL_1 = "ID";
    private static final String COL_2 = "SUBJECT_NAME";
    private static final String COL_3 = "SCOPE";
    private static final String COL_4 = "TEACHER";
    private static final String COL_5 = "SCHEDULE";
    private static final String COL_6 = "SUCCESS_RATE";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT,SUBJECT_NAME TEXT,SCOPE TEXT,TEACHER TEXT,SCHEDULE TEXT,SUCCESS_RATE TEXT)");
    }
    ...
    @SuppressLint("Range")
    public List<Subject> fetchDataFromDatabase() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                Subject subject = new Subject(id, subjectName, scope, teacher, schedule, successRate);
                data.add(subject);
            }
            cursor.close();
        }
